...
static void homing_amp_appear_loop(void) {
    // gLakituState[gCurrentMario].goalPos is the position lakitu is moving towards.
    ...
    f32 relativeTargetX = gLakituState[gCurrentMario].goalPos[0] - o->oPosX;
    f32 relativeTargetZ = gLakituState[gCurrentMario].goalPos[2] - o->oPosZ;
